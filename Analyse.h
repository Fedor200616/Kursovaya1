...
/// <summary>
/// Контекст анализа строки, используемый в функции analyse для передачи параметров между функциями обработки состояний
/// Это контекст внутри строки, который обновляется на каждой итерации цикла по символам строки.
/// </summary>
